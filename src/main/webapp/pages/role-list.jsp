...
<link rel="stylesheet"
	...
	<script type="text/javascript">
		function del(id) {
			alert("ok");
		location.href=#{pageContext.request.contextPath}"/role/deleteById?id="+id
		}
	</script>
</head>
										...
										<c:forEach var="role" items="${requestScope.listRole}">
											<tr>
												...
												<td class="text-center">
													...
													<input type="button" onclick="function x() {
													  alert('ok')
													}" class="btn bg-olive btn-xs" value="删除">
<%--													<a onclick="del(6)" class="btn bg-olive btn-xs">删除</a>--%>
												</td>
											</tr>
										</c:forEach>
